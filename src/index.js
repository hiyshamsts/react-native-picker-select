...
export default class RNPickerSelect extends PureComponent {
  ...
  onValueChange(value, index) {
    ...
    let selItem = (selItem = this.state.selectedItem ? this.state.selectedItem.value : "")
    if (selItem === undefined || selItem === "") {
      selItem = null
    }
    ...
    if (value !== selItem) {
      if (this.props.isFollower) {
        ...
        this.props.onValueChange(value, this.state.items[index].label, index, this.state.items[index].profitSharingMap ? this.state.items[index].profitSharingMap : null)
      }
  ...
  renderPlaceholderStyle() {
    ...
    if (!isEqual(this.props.placeholder, {}) && this.state.selectedItem.label === this.props.placeholder.label) {
  ...
  renderIOS() {
    return (
      <View style={[styles.viewContainer, this.props.style.viewContainer]}>
        ...
        <Modal visible={this.state.showPicker} transparent animationType={this.state.animationType}>
          <TouchableOpacity
          ...
          <View style={[styles.modalViewBottom, this.props.style.modalViewBottom]}>
            <Picker onValueChange={this.onValueChange} selectedValue={this.state.selectedItem ? this.state.selectedItem.value : ""} testId="RNPickerSelectIOS">
